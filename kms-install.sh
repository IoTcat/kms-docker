...
#kms-centos by iotcat (https://iotcat.me)
...
start(){
	...
	echo "You can use kms start to manage the service."
	echo "Thanks for your using!"
	echo "IoTcat <i@iotcat.me>"
}
...
echo "Scrpit developed by iotcat <i@iotcat.me>"
start
